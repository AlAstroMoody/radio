...
const emit = defineEmits<{
  'update:isRadioMode': [value: boolean]
}>()
...
function toggleMode() {
  emit('update:isRadioMode', !props.isRadioMode)
}
</script>

<template>
  <div class="fixed bottom-0 left-0 right-0 w-fit overflow-visible z-50">
    <div class="flex gap-4 items-center p-1 rounded-tr-2xl border-r-0 border-b-0 bg-glass backdrop-blur-xl border border-glass shadow-lg transition-all duration-300 dark:bg-glass-purple dark:border-glass-purple-border">
